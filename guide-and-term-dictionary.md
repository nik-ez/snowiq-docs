...
#### Driver Status
  ...
  * Offline – is for users that are not logged into the SNOWiQ Driver Application, drivers that are out of range of the service area (out of range), or any drivers that are not able to broadcast/receive GPS coordinates to the system (out of service).
  ...
  ![Driver Status](/images/home/guide-and-term-dictionary/driver-status.png)
</section>
</section>
...
![Route Status](/images/home/guide-and-term-dictionary/route-status.png)
</section>
</section>  
...
![Assignment Status](/images/home/guide-and-term-dictionary/assignment-status.png)
</section>
</section>
...
![Ticket Status](/images/home/guide-and-term-dictionary/ticket-status.png)
</section>
</section> 
</section>
</section>
